           ...
           <div class="box box-primary">
               <div class="box-header with-border">
                <select name="selectStock" id="selectStock" class="selectStock pull-right">
                    @if ($urlstatus == 'critical')
                    <option value="all">All</option>
                    <option value="5" selected>Critical Stock</option>
               ...
               <div class="container-fluid" style="margin-top:1%">
                <table id="mytable" class="table display nowrap" style="width:100%">
                    <thead class="">
                        <tr>
                            <th><h5>Barcode</h5> </th>
                            <th class="all"><h5>Name</h5></th>
                            <th><h5>Net WT.</h5></th>
                            <th><h5>Unit</h5></th>
                            <th><h5>Stock on Hand</h5></th>
                            <th class="none"><h5>Brand:</h5></th>
                            <th class="none"><h5>Category: </h5></th>
                            <th><h5>Supplier: </h5></th>
                            <th class="all"><h5>Action</h5></th>
                        </tr>
                    </thead>
                    <tbody>    
                        @if (count($products) > 0)
